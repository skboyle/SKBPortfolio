...
const About: React.FC = () => {
  return (
    <div className="page" id="about">
      ...
      <h3>You can visit my LinkedIn, Github, and resume, or send me an email by using the icons at the bottom of the page. </h3>
      <img className="laptop" src="https://i.imgur.com/BnV5nqG.jpgg" alt="laptop" width="600px"/>
    </div>
  );
};
